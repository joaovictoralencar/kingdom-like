Shader "Lux URP/Projection/Decal Unlit"
{
    ...
    SubShader
    {
        ...
        //  It is a decal!
            ...
            //#include "Packages/com.unity.render-pipelines.universal/Shaders/UnlitInput.hlsl" // Unity 6. as HQ sampling broke the shader

            CBUFFER_START(UnityPerMaterial)
                half4 _Color;
                float2 _DistanceFade;
                float4 _BaseMap_TexelSize; // Unity 6
            CBUFFER_END
            ...
            TEXTURE2D(_BaseMap); SAMPLER(sampler_BaseMap); // Unity 6
