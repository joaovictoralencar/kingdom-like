...
//      ///////////////////////////////////////
//      As we manipulate vertices we have to add custom MV passes
        ...
        Pass
        {
            ...
            #include "Includes/Lux URP Billboard Inputs.hlsl"
            #include "Includes/Lux URP Billboard MotionVectors Pass.hlsl"
            ENDHLSL
        }
...
//      ///////////////////////////////////////
//      As we manipulate vertices we have to add custom selection and picking passes
        Pass
        {
            ...
            // Pragmas
            #pragma target 2.0
            #pragma vertex SelectionPassVertex
            #pragma fragment SelectionPassFragment
            ...
            #include "Includes/Lux URP Billboard Inputs.hlsl"
            #include "Includes/Lux URP Billboard Selection Pass.hlsl"
    ...
    CustomEditor "LuxURPEssentials.LuxURPCustomBillboardShaderGUI"
}