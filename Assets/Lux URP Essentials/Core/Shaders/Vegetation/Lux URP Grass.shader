...
// Shader supports Motion Vectors. If you do not want or can't afford them simply "comment" the associated passes
// Motion Vector passes are at the very end of this file.
// You can comment them by changing their Name and Lightmode.
// Take the original Name and Tag:
// Name "MotionVectors"
// Tags { "LightMode" = "MotionVectors" }
// and set them to e.g.
// Name "MotionVectorsXX"
// Tags { "LightMode" = "MotionVectorsXX" } 
...
Cull [_Cull]
            ...
            #include "Includes/Lux URP Grass Inputs.hlsl"
            #include "Includes/Lux URP Grass MotionVectors Pass.hlsl"
            ENDHLSL
        }
...
#define APPLICATION_SPACE_WARP_MOTION 1
    ...
    CustomEditor "LuxURPEssentials.LuxURPCustomSingleSidedShaderGUI"
}