...
//  Two sided geometry: orient the normal towards the light source.
//  On back faces the authored normal points away from the light, so ApplyShadowBias
//  would pick invNdotL = 1 (its maximum normal bias) and apply it along -light -
//  pushing the caster into the surface and making concave areas shadow themselves.
