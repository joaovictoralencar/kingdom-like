Shader "Lux URP/Particles/Simple Lit Tess"
{
// ------------------------------------------
...
// Per pixel or per vertex shadows
    ...
    Properties
    {
        ...
        [Header(Tessellation)]
        [Space(8)]
        [IntRange] _Tess                        ("Tessellation", Range(1, 15)) = 3
        [LuxURPVectorTwoDrawer]
        _TessRange                              ("Near (X) Far (Y)", Vector) = (5,15,0,0)
    ...
    SubShader
    {
        ...
        //  When using Forward+ we skip per vertex shadows :(
            ...
            #pragma vertex ParticlesLitTessVertex
            #pragma fragment ParticlesLitFragment
            
            #define BUMP_SCALE_NOT_SUPPORTED 1

            #define _USESTESSELLATION
    ...
    Fallback "Lux URP/Particles/Simple Lit"
    CustomEditor "LuxURPEssentials.LuxURPParticlesCustomShaderGUI"
}
