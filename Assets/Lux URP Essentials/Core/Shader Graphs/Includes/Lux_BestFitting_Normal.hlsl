...
//  For this reason we declare a customNormalWS and include our custom "PackGBuffersSurfaceData" and "PackGBuffersBRDFData" functions by including "Lux_GBuffer.hlsl"
