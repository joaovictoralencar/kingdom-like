		...
		public void OnGUI()
		{
			...
			GUILayout.BeginHorizontal();
				...
				EditorGUILayout.LabelField(
					"Currently installed: Version 2.07 for Unity 6000.3.10f1 and URP 17.3.0 (February 17, 2026)", _style_bodytxt);
				GUILayout.Space(16);
			GUILayout.EndHorizontal();
			...
			GUILayout.BeginHorizontal();
				GUILayout.Space(16);
				EditorGUILayout.LabelField(
					"The package you have downloaded from the asset store installed shaders compatible with URP 17.3.0. " + 
